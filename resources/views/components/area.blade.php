                ...
                <form action="{{ route('areas.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="display_in_breach_list" class="inline-flex items-center">
                            <input type="checkbox" id="display_in_breach_list" name="display_in_breach_list"
                                   class="form-checkbox" {{ old('display_in_breach_list') ? 'checked' : '' }}>
                    ...
                    <button type="submit" class="w-full px-4 py-2 bg-blue-600 text-white font-bold rounded-md">Save
                        Area
                    </button>
                </form>
            </div>
